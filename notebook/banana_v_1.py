...
Original file is located at
    https://colab.research.google.com/drive/166fWlp3k0ZinHhSdgYarGAdHoTl_rKmz

# Klasifikasi Pisang: CNN From Scratch vs MobileNetV2
...
# Output
OUTPUT_DIR = Path("/content/databanana_outputs")
...
# The following code will only execute successfully when compression is complete
...
ZIP_BASE = Path("/content/databanana_submission")
